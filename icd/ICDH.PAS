...
procedure cruler; external; { clear ruler }
{ rationalize line }
...
procedure updrul; external; { update ruler display }
{ redraw real region }
...
procedure clip(var x1, y1, x2, y2: integer; 
               var inside: boolean; r: region); external;
{}
{**************************************************************
